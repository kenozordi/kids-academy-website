...
<head>
    ...
    <title>Eduko - Online Course & Education HTML5 Template</title>
...
<body>
    ...
    <div class="page-wrapper">
                                ...
                                <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li class="menu-item-has-children">
                                            <a href="#">Courses</a>
                                            <ul class="sub-menu">
                                                <li><a href="course.html">Courses Style 1</a></li>
                                                <li><a href="course-2.html">Courses Style 2</a></li>
                                                <li><a href="course-3.html">Courses Style 3</a></li>
                            ...
                            <div class="col-lg-3 col-md-3 col-2">
                                <div class="header-right">
                                    ...
                                    <div class="close-form">
                                        <a class="login" href="login.html"><span class="text">Sign In</span>
                                            <span class="mobile">
                                                <i class="fi flaticon-charity"></i>
                                            </span></a>
                                        <a class="theme-btn" href="register.html"><span class="text">Sign Up</span>
                                            <span class="mobile">
                                                <i class="fi flaticon-charity"></i>
                                            </span></a>
                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="hero-content">
                            ...
                            <div data-swiper-parallax="500" class="slide-btns">
                                ...
                                <ul>
                                    <li class="video-holder">
                                        <a href="https://www.youtube.com/embed/r5sw-6lJmTA?autoplay=1" class="video-btn"
                                            data-type="iframe" tabindex="0"><i class="fi flaticon-play"></i></a>
                                    </li>
                                    <li class="video-text">
                                        <a href="https://www.youtube.com/embed/r5sw-6lJmTA?autoplay=1" class="video-btn"
                            ...
                            <div class="student-pic">
                                ...
                                <div class="wp-shape-1"><img src="assets/images/slider/shape-1.svg" alt=""></div>
                                <div class="wp-shape-2"><img src="assets/images/slider/shape-2.svg" alt=""></div>
                                <div class="wp-shape-3"><img src="assets/images/slider/shape-3.svg" alt=""></div>
                                <div class="wp-shape-4"><img src="assets/images/slider/shape-4.svg" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 941" fill="none">
                    ...
                    <defs>
                        <linearGradient id="paint0_linear_245_1456" x1="972" y1="0.702148" x2="972" y2="811"
                            ...
                            <stop offset="1" stop-color="#EEEDFA" />
                        </linearGradient>
                    </defs>
                </svg>
            </div>
                            ...
                            <div class="feature-item-wrap">
                                ...
                                <div class="feature-item-hidden">
                                    ...
                                    <div class="feature-text">
                                        <h2><a href="course.html">1250+ Courses</a></h2>
                                        <p>We are providing best Courses. That help you be expert.</p>
                                        <a class="more" href="course.html">Read More...</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="wpo-courses-section-s2 section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row wpo-courses-wrap">
                    <div class="col-lg-4 col-md-6 col-12 grid s1">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                ...
                                <p>We are providing you the best UI/UX design guideline. That help you be professional
                                    and talented designer. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12 grid s2">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                <div class="courses-icon">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 grid s3">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                <div class="courses-icon">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 grid s4">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                <div class="courses-icon">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 grid s5">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                <div class="courses-icon">
                                    <i class="fi flaticon-responsible"></i>
                                </div>
                                <h2><a href="course-single.html">Business Analysis</a></h2>
                                <p>We are providing you the best UI/UX design guideline. That help you be professional
                                    and talented designer. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12 grid s6">
                        <div class="wpo-courses-item">
                            <div class="wpo-courses-text">
                                <div class="courses-icon">
                                    <i class="fi flaticon-paint-palette"></i>
                                </div>
                                <h2><a href="course-single.html">Graphic Design</a></h2>
                                <p>We are providing you the best UI/UX design guideline. That help you be professional
                                    and talented designer. </p>
                            </div>
                        </div>
        ...
        <div class="wpo-popular-area section-padding">
            <div class="container">
                <div class="wpo-section-title-s2">
                    <small>Popular Courses</small>
                    <h2>Discover Your Favorite Courses
                    </h2>
                </div>
                    ...
                    <div class="row">
                                ...
                                <div class="wpo-popular-item">
                                    ...
                                    <div class="wpo-popular-content">
                                        <div class="wpo-popular-text-top">
                                            <ul>
                                                <li><img src="assets/images/popular/avater/img-1.jpg" alt=""></li>
                                                <li><a href="course.html">Robert Henry</a></li>
                                            </ul>
                                            <ul>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-popular-single">
                                <div class="wpo-popular-item">
                                    <div class="wpo-popular-img">
                                        <img src="assets/images/popular/img-2.jpg" alt="">
                                        <div class="thumb">
                                            <span>$200</span>
                                        </div>
                                    </div>
                                    <div class="wpo-popular-content">
                                        <div class="wpo-popular-text-top">
                                            <ul>
                                                <li><img src="assets/images/popular/avater/img-2.jpg" alt=""></li>
                                                <li><a href="course-single.html">Jenny Wilson</a></li>
                                            </ul>
                                            <ul>
                                                <li><i class="fi flaticon-star"></i></li>
                                                <li>(5.0)</li>
                                        ...
                                        <h2><a href="course-single.html">The Complete Guide to Be a Graphics
                                                Designer.</a>
                                        </h2>

                                        <div class="wpo-popular-text-bottom">
                                            <ul>
                                                <li><i class="fi flaticon-reading-book"></i> 365 Students</li>
                                                <li><i class="fi flaticon-agenda"></i> 35 Lesson</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-popular-single">
                                <div class="wpo-popular-item">
                                    <div class="wpo-popular-img">
                                        <img src="assets/images/popular/img-3.jpg" alt="">
                                        <div class="thumb">
                                            <span>$90</span>
                                        </div>
                                    </div>
                                    <div class="wpo-popular-content">
                                        <div class="wpo-popular-text-top">
                                            <ul>
                                                <li><img src="assets/images/popular/avater/img-3.jpg" alt=""></li>
                                                <li><a href="course.html">Jerome Bell</a></li>
                                            </ul>
                                            <ul>
                                                <li><i class="fi flaticon-star"></i></li>
                                                <li>(4.9)</li>
                                        ...
                                        <h2><a href="course-single.html">Learning How To Write As A Professional
                                                Author</a>
                                        </h2>

                                        <div class="wpo-popular-text-bottom">
                                            <ul>
                                                <li><i class="fi flaticon-reading-book"></i> 134 Students</li>
                                                <li><i class="fi flaticon-agenda"></i> 12 Lesson</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="wpo-testimonial-section section-padding">
            <div class="container">
                ...
                <div class="wpo-testimonial-wrap">
                    <div class="row align-items-center">
                        <div class="wpo-testimonial-items wpo-testimonial-active owl-carousel">
                            <div class="wpo-testimonial-item">
                                <div class="wpo-testimonial-text">
                                    ...
                                    <i class="quote fi flaticon-right-quote-sign"></i>
                                    <p>I can't express enough gratitude for the awesome experience I had during my
                                        education journey. As a beginner they support me as much possible.</p>
                                </div>
                            </div>
                            <div class="wpo-testimonial-item">
                                <div class="wpo-testimonial-text">
                                    <div class="wpo-testimonial-text-btm">
                                        ...
                                        <div class="wpo-testimonial-text-btm-info">
                                            <h3>Eleanor Pena</h3>
                                            <span>Students of Graphic Designer</span>
                                        </div>
                                    </div>
                                    <ul>
                                        <li><i class="fi flaticon-star"></i></li>
                                        ...
                                        <li><i class="fi flaticon-star"></i></li>
                                        <li><i class="fi flaticon-star"></i></li>
                                        <li><i class="fi flaticon-star off"></i></li>
                                        <li>(4.0)</li>
                                    </ul>
                                    <i class="quote fi flaticon-right-quote-sign"></i>
                                    <p>I can't express enough gratitude for the awesome experience I had during my
            ...
            <div class="shape-1"><img src="assets/images/testimonial/shape-1.png" alt=""></div>
            <div class="shape-2"><img src="assets/images/testimonial/shape-2.png" alt=""></div>
        </section>
        <!--End wpo-testimonial-section-->

        <!-- start wpo-choose-section -->
        <section class="wpo-choose-section-s2 section-padding">
            <div class="container">
                <div class="right-img">
                    <img src="assets/images/choose2.jpg" alt="">
                    <a href="https://www.youtube.com/embed/r5sw-6lJmTA?autoplay=1" class="video-btn" data-type="iframe">
                        <i class="fi flaticon-play-1"></i>
                    </a>
                </div>
                <div class="wpo-choose-wrap">
                    <div class="wpo-choose-grids clearfix">
                        <div class="grid">
                            <div class="icon">
                                <i class="fi flaticon-training"></i>
                            </div>
                        ...
                        <div class="grid">
                            ...
                            <div class="info">
                                ...
                                <p>We are always here to help our students and solve problems.</p>
                            </div>
                        </div>
                        <div class="grid">
                            <div class="icon">
        ...
        <section class="wpo-subscribe-section-s2 section-padding">
            <div class="container-fluid">
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-blog-item">
                                ...
                                <div class="wpo-blog-content">
                                    ...
                                    <h2><a href="blog.html">The Surprising Reason College Tuition Is Crazy Expensive</a>
                                    </h2>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col col-lg-6 col-md-12 col-12">
                            <ul>
                                <li>&copy; 2023 <a href="#">Eduko</a>. All rights reserved.</li>
                            </ul>
                        </div>
                        <div class="col col-lg-6 col-md-12 col-12">
                            <div class="link">
